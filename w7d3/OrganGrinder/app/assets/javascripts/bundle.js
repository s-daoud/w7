...
/***/ function(module, exports, __webpack_require__) {
	...
	var Organ = __webpack_require__(194);
	var Recorder = __webpack_require__(195);
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(OrganGrinder, null), document.getElementById("content"));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TONES = __webpack_require__(192);
	...
	var NoteKey = React.createClass({
	  ...
	  render: function render() {
	    var cName = 'key ' + this.props.noteName;
	    return React.createElement(
	      'div',
	      { className: cName },
	      this.props.noteName
	...
	KeyStore.__onDispatch = function (payload) {
	  switch (payload.actionType) {
	    ...
	    case "UPDATE_NOTES":
	      ...
	      try {
	        for (var _iterator = payload.notes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var KeyActions = {
	  keyPressed: function keyPressed(code) {
	    dispatcher.dispatch({ key: Mapping[code],
	      actionType: "KEY_DOWN" });
	  },
	  keyReleased: function keyReleased(code) {
	    dispatcher.dispatch({ key: Mapping[code],
	      actionType: "KEY_UP" });
	  },
	  playbackUpdate: function playbackUpdate(notes) {
	    dispatcher.dispatch({ notes: notes,
	      actionType: "UPDATE_NOTES" });
	  },
	  addTracks: function addTracks(track) {
	    dispatcher.dispatch({ track: track,
	      actionType: "ADD_TRACK" });
	  },
	  removeTracks: function removeTracks(track) {
	    dispatcher.dispatch({ track: track,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Tones = __webpack_require__(192);
	var NoteKey = __webpack_require__(169);
	...
	var Organ = React.createClass({
	  ...
	  _handleKeyReleased: function _handleKeyReleased(e) {
	    var code = e.keyCode;
	  ...
	  render: function render() {
	    ...
	    for (var noteName in Tones) {
	      noteKeys.push(React.createElement(NoteKey, { noteName: noteName, key: noteName }));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var Track = __webpack_require__(196);
	var KeyStore = __webpack_require__(170);
	var TrackStore = __webpack_require__(197);
	var KeyActions = __webpack_require__(193);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Track = function Track(attributes) {
	  var defaults = { name: "New Track", roll: [] };
	...
	Track.prototype.intervalCallback = function (playBackStartTime) {
	  if (this.currentNote < this.roll.length) {
	    ...
	    if (delta >= this.roll[this.currentNote].timeSlice) {
	      var notes = this.roll[this.currentNote].notes || [];
	...
	Track.prototype.play = function () {
	  ...
	  var intervalCallback = this.intervalCallback.bind(this, playBackStartTime);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Track = __webpack_require__(196);
	var TrackStore = __webpack_require__(197);
	var TrackPlayer = __webpack_require__(199);
	...
	var Jukebox = React.createClass({
	  ...
	  _updateTrack: function _updateTrack() {
	    this.setState({ tracks: TrackStore.all() });
	  },
	  render: function render() {
	    var allTracks = [];
	    for (var track in this.state.tracks) {
	      allTracks.push(React.createElement(TrackPlayer, { track: this.state.tracks[track], key: track.name }));
	    }
	    return React.createElement(
	      'div',
	      null,
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'button',
	        { className: 'play',
	          onClick: this.props.track.play.bind(this.props.track) },
	        'Play Back'
	      ),
	      React.createElement(
	        'button',
