...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(Widget, null), document.getElementById('widget'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Widget = React.createClass({
	  ...
	  render: function render() {
	    var nonsense = [{ title: "Unicorns", content: "haosdjfaiosdjfaosdijffiadfijaosdjf" }, { title: "Dragons", content: "RAWWWWRARRAWRWARAWRARWWRA" }, { title: "Chimaera", content: "uhhhhh what?" }];
	    var names = ["Fiora", "Dr Mundo", "Anivia", "Nasus", "Leona", "Morgana", "Annie", "Hecarim", "Miss Fortune", "Lux", "Jax"];
	
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(Tabs, { tabData: nonsense }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = React.createClass({
	  ...
	  render: function render() {
	    ...
	    //ASK ABOUT KEY
	    var titles = this.props.tabData.map(function (data, i) {
	      return React.createElement(
	        'li',
	        null,
	        React.createElement(
	          'h1',
	          { onClick: _this.switchIndex.bind(_this, i), key: i },
	          data.title
	        )
	      );
	    });
	
	    var tabContent = this.props.tabData[this.state.selectIndex].content;
	  ...
	  switchIndex: function switchIndex(i) {
	    this.setState({
	      selectIndex: i
	    });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  success: function success(pos) {
	    ...
	    var urlvar = "http://api.openweathermap.org/data/2.5/weather?lat=" + latitude + "&lon=" + longitude + "&appid=645c5d39c7603f17e23fcaffcea1a3c1";
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        "div",
	        null,
	        JSON.stringify(this.state.weatherRes)
	      ),
	      React.createElement(
	        "div",
	        null,
	        JSON.stringify(this.state.temperatureRes)
	      )
	    );
	  }
	});
	...
	var AutoComplete = React.createClass({
	  ...
	  handleInput: function handleInput(e) {
	    this.setState({ query: e.target.value,
	      nameList: this.props.names.filter(function (name) {
	        return name.toLowerCase().includes(e.target.value);
	      })
	    });
	  },
	  autoName: function autoName(e) {
	    this.setState({ query: e.target.className, nameList: [e.target.className] });
	  },
	  render: function render() {
	    var _this = this;
	
	    var searchNames = this.state.nameList.map(function (name) {
	      return React.createElement(
	        'li',
	        { key: name, className: name, onClick: _this.autoName },
	        name
	      );
	    });
	    ...
	    return React.createElement(
	      'div',
	      null,
	      React.createElement('input', { type: 'text', value: this.state.query, onChange: this.handleInput }),
	      React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          ReactCSSTransitionGroup,
	          { transitionName: 'auto', transitionEnterTimeout: 500,
